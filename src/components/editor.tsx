            ...
            <div className="relative size-[64px] flex items-center justify-center group/image">
              <Hint label="Remove image">
                <button
                  ...
                  className="hidden group-hover/image:flex rounded-full bg-black/70 hover:bg-black -top-2.5 -right-2.5 absolute text-white size-6 z-[4] border-2 border-white items-center justify-center"
                >
